...
#include "ui_gestion_examens_medicaux.h"
...
gestion_examens_medicaux::gestion_examens_medicaux(QWidget *parent) :
    QDialog(parent),
...
gestion_examens_medicaux::~gestion_examens_medicaux()
{delete ui;}


void gestion_examens_medicaux::on_pb_ajouter_clicked()
...
void gestion_examens_medicaux::on_pb_annuler_ajout_clicked()
{ui->le_id->clear();
ui->le_nom->clear();
ui->le_type->clear();
ui->le_age->clear();
...
void gestion_examens_medicaux::on_pb_supprimer_clicked()
...
void gestion_examens_medicaux::on_pb_annuler_supp_clicked()
{ui->le_id_supp->clear();}




void gestion_examens_medicaux::on_pb_modif_clicked()
...
void gestion_examens_medicaux::on_pb_annuler_modif_clicked()
...
void gestion_examens_medicaux::on_recherche_id_clicked()
...
void gestion_examens_medicaux::on_recherche_nom_clicked()
...
void gestion_examens_medicaux::on_recherche_type_clicked()
...
void gestion_examens_medicaux::on_recherche_age_clicked()
...
void gestion_examens_medicaux::on_recherche_etat_clicked()
...
void gestion_examens_medicaux::on_recherche_coordonnees_clicked()
...
void gestion_examens_medicaux::on_pb_annuler_recherche_clicked()
...
void gestion_examens_medicaux::on_tri_id_clicked()
...
void gestion_examens_medicaux::on_tri_nom_clicked()
...
void gestion_examens_medicaux::on_tri_type_clicked()
...
void gestion_examens_medicaux::on_tri_age_clicked()
...
void gestion_examens_medicaux::on_tri_etat_clicked()
...
void gestion_examens_medicaux::on_tri_coordonnees_clicked()
...
void gestion_examens_medicaux::on_pb_ajouter_antecedants_clicked()
...
void gestion_examens_medicaux::on_pb_supprimer_antecedants_clicked()
{int id= ui->le_id_antecedants->text().toInt();
...
void gestion_examens_medicaux::on_pb_annuler_antecedants_clicked()
{ui->le_id_antecedants->clear();}



void gestion_examens_medicaux::on_pb_pdf_clicked()
{QTableView *table;
...
void gestion_examens_medicaux::on_pb_excel_clicked()
{QTableView *table;
table = ui->tab_antecedants;
...
void gestion_examens_medicaux::on_pb_resultat_clicked()
...
void gestion_examens_medicaux::on_pb_annuler_resultat_clicked()
{ui->le_id_resultats->clear();}




void gestion_examens_medicaux::on_sendMail_clicked()
...
void gestion_examens_medicaux::mailsent(QString status)
