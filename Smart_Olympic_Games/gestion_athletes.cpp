...
gestion_athletes::gestion_athletes(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::gestion_athletes)
{
    ui->setupUi(this);
setWindowTitle("Gestion des athlétes");
...
gestion_athletes::~gestion_athletes()
{
    delete ui;
}


void gestion_athletes::on_boutton_ajouterath_clicked()
{
     bool test=false;
     //bool test2=false;
...
void gestion_athletes::on_boutton_supprimerath_clicked()
{
...
void gestion_athletes::on_table_athletes_2_activated(const QModelIndex &index)
{
    QSqlQuery query;
...
void gestion_athletes::on_pushButton_Modifierath_clicked()
{
...
void gestion_athletes::on_bouton_rechercherath_clicked()
{
...
void gestion_athletes::on_comboBox_trierath_currentIndexChanged(int index)
{
    if(index==1)
...
void gestion_athletes::on_bouton_PDF_clicked()
{
...
void gestion_athletes::on_bouton_excel_clicked()
{
    QTableView *table;
...
void gestion_athletes::on_bouton_URL_clicked()
{
    QString link="http://www.google.com";
    QDesktopServices::openUrl(QUrl(link));
}

/*void gestion_athletes::update_label()
{
