...
gestion_stades::gestion_stades(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::gestion_stades)
{
    ui->setupUi(this);
    setWindowTitle("Gestion des stades");
...
void gestion_stades::on_pb_ajouter_clicked()
{
...
void gestion_stades::on_pb_supprimer_clicked()
...
void gestion_stades::on_pb_modifier_clicked()
{
...
void gestion_stades::on_cb_tri_currentIndexChanged(int index)
{
    if(index==1)
...
void gestion_stades::on_pb_annuler_clicked()
{
    ui->le_id->setText(0);
    ui->tab_stade->setModel(S.afficher());
}

void gestion_stades::on_pb_ajouter_agent_clicked()
{
...
void gestion_stades::on_pb_supprimer_agent_clicked()
{
    Agent A;
...
void gestion_stades::on_pb_modifier_agent_clicked()
{
    int id_agent=ui->le_id_agent->text().toInt();
    QString nom_agent=ui->le_nom_agent->text();
    QString prenom_agent=ui->le_prenom_agent->text();
...
void gestion_stades::on_cb_trier_agent_currentIndexChanged(int index)
{
    if(index==1)
          {
...
void gestion_stades::on_pb_annuler_agent_clicked()
{
...
void gestion_stades::on_pb_ajouter_fan_clicked()
{
...
void gestion_stades::on_pb_supprimer_fan_clicked()
{
   Fan F;
...
void gestion_stades::on_pb_modifier_fan_clicked()
{
    int id_fan=ui->le_id_fan->text().toInt();
    QString nom_fan=ui->le_nom_fan->text();
    QString prenom_fan=ui->le_prenom_fan->text();
...
void gestion_stades::on_cb_trier_fan_currentIndexChanged(int index)
{
    if(index==1)
          {
...
void gestion_stades::on_pb_annuler_fan_clicked()
{
...
void gestion_stades::stats(QString table,QString critere,int valeur1,int valeur2,QString unite)
{
...
void gestion_stades::on_statsStadeCapacite_clicked()
{
    stats("STADES","CAPACITE_STADE",100,200,"Spectateurs");

}

void gestion_stades::on_statsStadeSurface_clicked()
{
    stats("STADES","SURFACE",10,100,"Mcube");

}

void gestion_stades::on_statsStadeNbrEvent_clicked()
{
...
void gestion_stades::on_pb_football_clicked()
{
...
void gestion_stades::on_pb_athletisme_clicked()
{
...
void gestion_stades::on_pb_ajouter_affectation_clicked()
{
...
void gestion_stades::on_pb_supprimer_affectation_clicked()
{
    Affectation Aff;
...
void gestion_stades::on_pb_modifier_affectation_clicked()
{
    int id_aff=ui->le_id_final->text().toInt();
    int num_evenement=ui->le_num_evenement->text().toInt();
    QString specialite_aff=ui->cb_specialite_aff->currentText();
...
void gestion_stades::on_lineEditRechercheStade_textChanged(const QString &arg1)
{
...
void gestion_stades::on_lineEditRechercheAgent_textChanged(const QString &arg1)
{
...
void gestion_stades::on_lineEditRechercheFan_textChanged(const QString &arg1)
{
...
void gestion_stades::on_valabiliteFan_clicked()
{
