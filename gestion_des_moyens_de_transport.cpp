...
#include "ui_gestion_des_moyens_de_transport.h"
...
gestion_des_moyens_de_transport::gestion_des_moyens_de_transport(QWidget *parent) :
    QDialog(parent),
...
gestion_des_moyens_de_transport::~gestion_des_moyens_de_transport()
{delete ui;}



void gestion_des_moyens_de_transport::on_B_Ajouter_clicked()
...
void gestion_des_moyens_de_transport::on_B_supp_clicked()
{QMessageBox msgBox;
int id=ui->le_id_supp->text().toInt();
bool result=M.supprimer(id);
if((result))
{QMessageBox::information(nullptr, QObject::tr("Supprimer un moyen de transport"),QObject::tr("Suppression effectuée.\n" "Click Cancel to exit."), QMessageBox::Cancel);}
else
QMessageBox::critical(nullptr, QObject::tr("Supprimer un moyen de transport"),QObject::tr("Suppression non effectuée !.\n""Click Cancel to exit."), QMessageBox::Cancel);
ui->table_moyens->setModel(M.afficher());}




void gestion_des_moyens_de_transport::on_B_modifier_clicked()
...
if(test)
{ui->table_moyens->setModel(M.afficher());
QMessageBox::information(nullptr, QObject::tr("Modifier un moyen de transport"),QObject::tr("Modification effectuée.\n" "Click Cancel to exit."), QMessageBox::Cancel);}
else
QMessageBox::critical(nullptr, QObject::tr("Modifier un moyen de transport"),QObject::tr("Modification non effectuée !.\n" "Click Cancel to exit."), QMessageBox::Cancel);}





void gestion_des_moyens_de_transport::on_B_recherche_nom_clicked()
...
QMessageBox::information(nullptr, QObject::tr("Rechercher un moyen de transport par son nom"),QObject::tr("Element trouve.\n" "Click Cancel to exit."), QMessageBox::Cancel);}
else QMessageBox::critical(nullptr, QObject::tr("Rechercher un moyen de transport par son nom"),QObject::tr("Echec de recherche !.\n"  "Click Cancel to exit."), QMessageBox::Cancel);}




void gestion_des_moyens_de_transport::on_B_recherche_capacite_clicked()
...
QMessageBox::information(nullptr, QObject::tr("Rechercher un moyen de transport par sa capacite"),QObject::tr("Element trouve.\n" "Click Cancel to exit."), QMessageBox::Cancel);}
else
QMessageBox::critical(nullptr, QObject::tr("Rechercher un moyen de transport par sa capacite"),QObject::tr("Echec de recherche !.\n" "Click Cancel to exit."), QMessageBox::Cancel);}




void gestion_des_moyens_de_transport::on_B_recherche_dest_dep_clicked()
...
QMessageBox::information(nullptr, QObject::tr("Rechercher un moyen de transport par sa destination de depart"),QObject::tr("Element trouve.\n" "Click Cancel to exit."), QMessageBox::Cancel);}
else
QMessageBox::critical(nullptr, QObject::tr("Rechercher un moyen de transport par sa destination de depart"),QObject::tr("Echec de recherche !.\n" "Click Cancel to exit."), QMessageBox::Cancel);
}




void gestion_des_moyens_de_transport::on_B_choisir_clicked()
{int id =ui->le_choix_id->text().toInt();
MoyensDeTransport M;
QSqlQueryModel *test=M.choix_moyen(id);
if(test)
{ui->tab_choix->setModel(M.choix_moyen(id));
QMessageBox::information(nullptr, QObject::tr("Choisir un moyen de transport"),QObject::tr("Element choisi.\n" "Click Cancel to exit."), QMessageBox::Cancel);}
else
QMessageBox::critical(nullptr, QObject::tr("Choisir un moyen de transport"),QObject::tr("Element non choisi!.\n" "Click Cancel to exit."), QMessageBox::Cancel);}





void gestion_des_moyens_de_transport::on_B_recherche_type_clicked()
...
QMessageBox::information(nullptr, QObject::tr("Rechercher un moyen de transport par son type"),QObject::tr("Element trouve.\n" "Click Cancel to exit."), QMessageBox::Cancel);}
else
QMessageBox::critical(nullptr, QObject::tr("Rechercher un moyen de transport par son type"),QObject::tr("Echec de recherche !.\n" "Click Cancel to exit."), QMessageBox::Cancel);}





void gestion_des_moyens_de_transport::on_B_recherche_nbr_voyages_clicked()
...
QMessageBox::information(nullptr, QObject::tr("Rechercher un moyen de transport par son nombre de voyages"),QObject::tr("Element trouve.\n" "Click Cancel to exit."), QMessageBox::Cancel);}
else
QMessageBox::critical(nullptr, QObject::tr("Rechercher un moyen de transport par son nombre de voyages"),QObject::tr("Echec de recherche !.\n" "Click Cancel to exit."), QMessageBox::Cancel);}





void gestion_des_moyens_de_transport::on_B_recherche_dest_arr_clicked()
...
QMessageBox::information(nullptr, QObject::tr("Rechercher un moyen de transport par sa destination d'arrivee"),QObject::tr("Element trouve.\n" "Click Cancel to exit."), QMessageBox::Cancel);}
else
QMessageBox::critical(nullptr, QObject::tr("Rechercher un moyen de transport par sa destination d'arrivee"),QObject::tr("Echec de recherche!.\n" "Click Cancel to exit."), QMessageBox::Cancel);}





void gestion_des_moyens_de_transport::on_B_billet_entrer_clicked()
{QMessageBox msgbox;
...
if(test)
{ui->tab_aerien->setModel(M1.afficher_billet());
QMessageBox::information(nullptr, QObject::tr("Ajouter un billet"),QObject::tr("Billet ajoute.\n" "Click Cancel to exit."), QMessageBox::Cancel);}
else
QMessageBox::critical(nullptr, QObject::tr("Ajouter un billet"), QObject::tr("Billet non ajoute!.\n" "Click Cancel to exit."), QMessageBox::Cancel);}





void gestion_des_moyens_de_transport::on_B_QR_clicked()
...
if(test)
{ui->tab_QR->setModel(M1.afficher_billet());
QMessageBox::information(nullptr, QObject::tr("Generer un QR Code"),QObject::tr("QR code genere avec succes.\n" "Click Cancel to exit."), QMessageBox::Cancel);}
else
QMessageBox::critical(nullptr, QObject::tr("Generer un QR Code"),QObject::tr("Echec!.\n" "Click Cancel to exit."), QMessageBox::Cancel);}





void gestion_des_moyens_de_transport::addPoint(double x, double y)
...
void gestion_des_moyens_de_transport::clearData()
{qv_x.clear();
qv_y.clear();}
...
void gestion_des_moyens_de_transport::plot()
...
void gestion_des_moyens_de_transport::on_B_clear_clicked()
{clearData();
plot();}



void gestion_des_moyens_de_transport::on_B_ajouter_annuler_clicked()
{ui->le_id->clear();
ui->le_nom->clear();
ui->le_type->clear();
...
void gestion_des_moyens_de_transport::on_B_modifier_annuler_clicked()
{ui->le_m_id->clear();
ui->le_m_nom->clear();
ui->le_m_type->clear();
...
void gestion_des_moyens_de_transport::on_B_supprimer_annuler_clicked()
{ ui->le_id_supp->clear();}




void gestion_des_moyens_de_transport::on_B_QR_annuler_clicked()
{ui->le_QR_id->clear();
...
void gestion_des_moyens_de_transport::on_B_billet_annuler_clicked()
...
void gestion_des_moyens_de_transport::on_B_choix_annuler_clicked()
{ui->le_choix_id->clear();}




void gestion_des_moyens_de_transport::on_B_excel_clicked()
{QTableView *table;
table = ui->tab_choix;
